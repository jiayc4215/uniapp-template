<template>
  <view class="bg-fill-bottom text-text-main box-border flex flex-col items-center px-[32rpx] pt-[64rpx]">
    <view class="mb-[64rpx] flex flex-col items-center">
      <image src="/static/logo.png" class="bg-fill-content mb-[32rpx] h-[180rpx] w-[180rpx] rounded-[32rpx]" />
      <view class="text-[40rpx] font-bold tracking-wider">uniapp</view>
      <view class="text-text-auxiliary mt-[16rpx] text-[24rpx]">vite+vue3+js模版</view>
    </view>

    <view class="bg-fill-content relative mb-[64rpx] flex w-full overflow-hidden rounded-[24rpx] p-[8rpx]">
      <view
      ...
      <view
        ...
        :class="!isUser ? 'text-text-white' : 'text-text-auxiliary'"
    ...
    <view class="bg-fill-oppo mb-[64rpx] w-full rounded-[48rpx] p-[48rpx] shadow-sm">
      <view class="mb-[48rpx] text-center text-[32rpx] font-bold">账号密码登录</view>

      <wd-form ref="formRef" :model="form">
        <view class="border-line-main bg-fill-bottom mb-[32rpx] overflow-hidden rounded-[24rpx] border">
          <wd-input
