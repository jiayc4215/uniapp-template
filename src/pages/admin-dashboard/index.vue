<template>
  <view class="bg-gray-50 p-5">
    ...
    <!-- 饼图 -->
    <view class="rounded-3 mb-5 flex flex-col items-center justify-center bg-white p-5 shadow-sm">
      <view class="mb-5 text-center text-base font-medium text-gray-800"> 扫描下方二维码，加我为好友 </view>
