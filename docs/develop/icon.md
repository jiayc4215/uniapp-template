...
工程已安装并配置 [`@egoist/tailwindcss-icons`](https://www.npmjs.com/package/@egoist/tailwindcss-icons)。如需在新项目中接入，可安装依赖：
...
还需要安装对应的图标集合包。当前工程使用 `mdi`，依赖为 `@iconify-json/mdi`。
