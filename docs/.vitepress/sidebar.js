export const sidebar = [
  {
    ...
    items: [
      ...
      { text: "路由与权限", link: "/guide/router-permission" }
    ]
  },
  {
    text: "插件",
    items: [
      { text: "Uni Helper 插件", link: "/plugin/uni-helper" },
      { text: "unh", link: "/plugin/unh" },
      { text: "definePage", link: "/plugin/definepage" },
      { text: "uni-ku/root", link: "/plugin/uni-ku-root" },
  ...
  },
  {
    text: "开发",
    items: [
      { text: "小程序 icon 解决方案", link: "/develop/icon" },
